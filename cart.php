...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="itemlist.php"><span class="glyphicon glyphicon-cutlery"></span> All Furniture </a></li>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>Oops! We can't detect any items here. Go back and <a href="itemlist.php"> order now.</a></p>
